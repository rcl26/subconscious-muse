      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center p-4 z-10 font-helvetica">
        ...
        <div className="text-center max-w-2xl mx-auto mb-4">
          <div className="relative">
            ...
            {/* Mystical subtitle */}
            <div className="relative">
              <p className="text-lg md:text-3xl text-transparent bg-clip-text bg-gradient-to-r from-gray-400 via-gray-200 to-gray-300 leading-relaxed font-light tracking-wide">
                Track Your Dreams,
              </p>
              <p className="text-lg md:text-3xl text-transparent bg-clip-text bg-gradient-to-r from-gray-400 via-gray-200 to-gray-300 leading-relaxed font-light tracking-wide mb-2 md:mb-4">
        ...
        {/* CTA Section */}
        <div className="text-center max-w-2xl mx-auto mt-8 md:mt-12">
           {/* Mobile CTA */}
